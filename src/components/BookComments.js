...
const BookComments = ({ bookTitle, bookImage }) => {
  ...
  return (
    <Card className="book-comments">
      <Card.Body>
        <Row>
          <Col md={3}>
            <img src={`${process.env.PUBLIC_URL}/images/${bookImage}`} alt={bookTitle} className="book-image" />
          </Col>
          <Col md={9}>
            <div className="book-details">
              <h2>{bookTitle} Yorumları</h2>
        ...
        <div className="interaction-options">
          <Form.Group controlId="commentTextArea">
            <Form.Control
              as="textarea"
              rows="2"
              placeholder={`Yorumunuzu ${bookTitle} için buraya yazın...`}
              value={comment}
